$(document).ready(function(){
    ...
    */
    ...
    $(window).scroll(function() {
        ...
        }), a = true, $("#sticked-menu").removeClass("hidden-xs").removeClass("hidden-sm").addClass("animated slideInDown")) : (b && (b.destroy(), a = false), $("#sticked-menu").addClass("hidden-xs").addClass("hidden-sm").removeClass("animated slideInDown"))
    });
